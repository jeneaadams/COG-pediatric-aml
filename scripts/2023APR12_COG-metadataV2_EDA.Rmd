...
eligible patients with metadata and rnaseq

```{r}
length(intersect(rna$usi, new_pat.met_eligible$usi))
```
...
x2 = filter(new_pat.met_eligible, new_pat.met_eligible$usi %in% rna_tum$usi & new_pat.met_eligible$usi %in% wgs$usi & !new_pat.met_eligible$usi %in% rna_norm$usi)
