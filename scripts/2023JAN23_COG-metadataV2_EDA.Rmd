...
```{r}
npm.flt3 = cavatica.aaml2 %>% filter(npmstat_ == 1 & itdlowHAR == 1)
nrow(npm.flt3)
```

```{r}
# cavatica.aaml2 %>%
# if(npmstat_ == 1 & itdlowHAR == 1){ 
#   cavatica.aaml2$npm.flt3 = 3}else{
#     if(npmstat_ == 0 & itdlowHAR == 1){cavatica.aaml2$npm.flt3 = 2}else{
#       if(npmstat_ == 1 & itdlowHAR == 0){cavatica.aaml2$npm.flt3 = 1}
#     }}

# cavatica.aaml2 %>% if((npmstat_ == 1) & (itdlowHAR == 1)){
#   cavatica.aaml2$npm.flt3 = 3} else if((npmstat_ == 0)& (itdlowHAR == 1)){
#     cavatica.aaml2$npm.flt3 = 2
#   } else {
#     cavatica.aaml2$npm.flt3 = 1
#   }
